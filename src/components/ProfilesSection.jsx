...
const profiles = [
  { name: 'GitHub', icon: <Github size={48} />, url: 'https://github.com/nikeshh03', stat: '15+ Repositories', color: 'rgba(255, 255, 255, 1)' },
  { name: 'LinkedIn', icon: <Linkedin size={48} />, url: 'https://linkedin.com/in/nikesh-patil', stat: '500+ Connections', color: 'rgba(10, 102, 194, 1)' },
  { name: 'X', icon: <XIcon size={40} />, url: 'https://twitter.com', stat: 'Daily Active', color: 'rgba(255, 255, 255, 1)' },
  { name: 'LeetCode', icon: <Code2 size={48} />, url: 'https://leetcode.com', stat: '250+ Solved', color: 'rgba(255, 161, 22, 1)' },
  { name: 'CodeChef', icon: <ChefHat size={48} />, url: 'https://codechef.com', stat: '3★ Rated', color: 'rgba(91, 70, 56, 1)' },
];
